...
const dom = {
  ...
  // Cookie & Privacy elements
  cookieBanner: document.getElementById("cookie-banner"),
  acceptCookieBtn: document.getElementById("accept-cookie"),
  privacyLinkBanner: document.getElementById("privacy-link-banner"),
  privacyModal: document.getElementById("privacy-modal"),
  closePrivacyModal: document.getElementById("close-modal"),
};
...
const initCookieBanner = () => {
  ...
  const acceptBtn = dom.acceptCookieBtn;
  const privacyLink = dom.privacyLinkBanner;
  const modal = dom.privacyModal;
  const closeBtn = dom.closePrivacyModal;
...
const initializeApp = () => {
  ...
  // 初始化 Cookie Banner + Privacy Policy
  initCookieBanner();
};
